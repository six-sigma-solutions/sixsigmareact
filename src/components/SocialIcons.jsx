      ...
      <ul className="wrapper flex flex-wrap gap-4">
        ...
        <li className="icon facebook">
          <a href="#" aria-label="Facebook">
            ...
            <svg viewBox="0 0 320 512" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 fill-current">
        ...
        <li className="icon twitter">
          <a href="#" aria-label="X">
            ...
            <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 fill-current">
              <path d="M18.244 2H21.97l-8.13 9.293L23.5 22h-7.38l-5.78-7.46L4.92 22H1.19l8.68-9.92L.5 2h7.56l5.23 6.78L18.24 2z"/>
            </svg>
          </a>
        </li>
